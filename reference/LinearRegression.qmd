...
|--------|--------|-----------------------------------|------------|
| p      | int    | Number of covariates.             | _required_ |
| alpha  | float  | Significance level for inference. | _required_ |
| phi    | float  | Prior scale (default is 1).       | `1`        |

## Methods

| Name | Description |
| --- | --- |
| [infer](#savvi.linear_regression.LinearRegression.infer) | Perform statistical inference on the coefficients. |
...
### infer { #savvi.linear_regression.LinearRegression.infer }
